...
must _double_ for every 1V increase. A BJT transistor's base-emitter to collector-current
...
A dual supply is required (+9V / 0V / −9V). Options:
...
> Robin Mitchell, _"DIY Synth Series Part 1 — The Exponential VCO"_, All About Circuits, August 8, 2016.
